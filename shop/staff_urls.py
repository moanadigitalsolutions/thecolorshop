...
urlpatterns = [
    ...
    path('email-settings/', staff_views.email_settings, name='email_settings'),
    ...
    path('products/import-export/', staff_views.product_import_export, name='product_import_export'),
